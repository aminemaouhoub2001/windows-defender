      ...
      <div className="flex flex-col items-center justify-center py-16 px-4">
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-lg max-w-md w-full text-center">
          <p className="text-white text-sm mb-2">
            Project Name: <strong>{data?.projectName || 'example-project'}</strong>
          </p>
          <p className="text-white text-sm mb-2">
            Format: <strong>{data?.format || 'EXE'}</strong>
          </p>
          <p className="text-white text-sm mb-2">
            Technique: <strong>{data?.technique || 'Patch AMSI (API)'}</strong>
          </p>
          <p className="text-white text-sm mb-6">
            Generated on: <strong>{data?.timestamp || new Date().toLocaleString()}</strong>
          </p>
