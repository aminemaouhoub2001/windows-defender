...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      {/* BLOCK 2: ABOUT SECTION - grid background */}
      ...
      {/* BLOCK 3: TECHNIQUES - normal background */}
      <section className="bg-[#0a0a0a] py-24 px-6 border-t border-[#1d1d1d]">
      ...
      {/* BLOCK 4: RESOURCES - grid background */}
      ...
      {/* BLOCK 5: CALL TO ACTION - normal background */}
      <section className="bg-[#101010] py-16 px-8 text-center">
        ...
        <div className="flex justify-center space-x-4">
          <button className="bg-cyan-400 text-black px-6 py-2 rounded shadow hover:bg-cyan-300 transition">Join the Community</button>
          <button className="border border-gray-600 px-6 py-2 rounded hover:bg-gray-800 transition">Subscribe to Newsletter</button>
        </div>
      </section>

      {/* BLOCK 6: FOOTER - grid background */}
